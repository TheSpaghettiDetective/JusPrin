...
static std::vector<std::string> s_Preset_filament_options{
    ...
    "filament_shrinkage_compensation_z", "support_material_interface_fan_speed", "filament_notes" /*,"filament_seam_gap"*/,
    "filament_loading_speed", "filament_loading_speed_start", "filament_unloading_speed", "filament_unloading_speed_start",
    "filament_toolchange_delay", "filament_cooling_moves", "filament_stamping_loading_speed", "filament_stamping_distance",
    "filament_cooling_initial_speed", "filament_cooling_final_speed", "filament_ramming_parameters", "filament_multitool_ramming",
    "filament_multitool_ramming_volume", "filament_multitool_ramming_flow", "activate_chamber_temp_control",
...
void PresetCollection::dirty_config_options(const Preset*       edited,
                                            const Preset*       reference,
                                            DynamicPrintConfig& config,
                                            const bool          deep_compare)
{
    auto options = dirty_options(edited, reference, deep_compare);
    config       = edited->config;
    for (auto key : edited->config.keys()) {
