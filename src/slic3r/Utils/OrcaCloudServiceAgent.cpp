...
// Keyed by app so forks built from this source don't read OrcaSlicer's token ("OrcaSlicer/Auth" upstream).
constexpr const char* SECRET_STORE_SERVICE = SLIC3R_APP_KEY "/Auth";
