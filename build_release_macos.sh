...
function build_universal() {
    ...
    UNIVERSAL_APP="$PROJECT_BUILD_DIR/OrcaSlicer/JusPrin.app"
    rm -rf "$UNIVERSAL_APP"
    cp -R "$PROJECT_DIR/build/arm64/OrcaSlicer/JusPrin.app" "$UNIVERSAL_APP"
    ...
    lipo -create \
        "$PROJECT_DIR/build/x86_64/OrcaSlicer/JusPrin.app/$BINARY_PATH" \
        "$PROJECT_DIR/build/arm64/OrcaSlicer/JusPrin.app/$BINARY_PATH" \
