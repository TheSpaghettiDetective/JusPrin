...
**Status:** Process-settings implementation verified on macOS, including the live in-app Agent and Codex CLI acceptance scenario. Legacy MCP catalog cleanup remains a separate, gated commit.
