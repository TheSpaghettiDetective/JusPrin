...
4. [OrcaSlicer integration guide](orca-integration-guide.md) — known Orca behaviors, lifecycle traps, event and history constraints, testing lessons, and rebase guidance.
5. [Design system](design-system.md) — brand behavior, semantic UI tokens, typography, spacing, accessibility, and asset rules.
6. [POC reference](poc-reference.md) — exact pointers to the spike-only documents, code, commits, logs, screenshots, and generated brand artifacts left on `jusprin-v2-poc`.
