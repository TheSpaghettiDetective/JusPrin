    ...
    def test_packaged_helper_handshake_and_offline_without_gui_runtime(self):
        ...
        self.assertEqual({tool["name"] for tool in child.receive()["result"]["tools"]},
                         {"workspace_inspect", "settings_search", "settings_get", "settings_preview_patch", "settings_apply_patch",
                          "intent_update", "plan_set", "presets_list", "printer_list", "slice_start", "slice_report", "project_save", "history_restore", "printer_setup", "printer_setup_preview", "project_open", "object_analyze", "object_place", "plate_layout", "object_import_file", "project_delete_items", "region_annotate", "object_divide", "object_divide_preview", "object_merge", "object_repair"})
