...
TEST_CASE("OpenAI request preserves canonical schemas with compatible strictness", "[agent][openai]")
{
    ...
    CHECK(emitted_names == std::vector<std::string>{"duplicate_object", "history_restore", "inspect_selection", "intent_update", "plan_set", "presets_list", "printer_list", "printer_setup", "printer_setup_preview", "project_save", "settings_apply_patch", "settings_get", "settings_preview_patch", "settings_search", "slice_report", "slice_start", "workspace_inspect"});
          ...
          "[agent][openai][tools]")
{
    ...
    CHECK(names == std::vector<std::string>{"duplicate_object", "history_restore", "import_model", "inspect_selection", "intent_update", "plan_set", "presets_list", "printer_list", "printer_setup", "printer_setup_preview", "project_save", "settings_apply_patch", "settings_get", "settings_preview_patch", "settings_search", "slice_report", "slice_start", "workspace_inspect"});
