...
TEST_CASE("OpenAI request preserves canonical schemas with compatible strictness", "[agent][openai]")
{
    ...
    CHECK(emitted_names == std::vector<std::string>{"duplicate_object", "inspect_selection", "intent_update", "plan_set", "settings_apply_patch", "settings_get", "settings_preview_patch", "settings_search", "slice_report", "slice_start", "workspace_inspect"});
          ...
          "[agent][openai][tools]")
{
    ...
    CHECK(names == std::vector<std::string>{"duplicate_object", "import_model", "inspect_selection", "intent_update", "plan_set", "settings_apply_patch", "settings_get", "settings_preview_patch", "settings_search", "slice_report", "slice_start", "workspace_inspect"});
